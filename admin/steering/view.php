...
$page_title = 'ข้อมูลกรรมการอำนวยการ';
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">ข้อมูลกรรมการอำนวยการ</h1>
        <div>
    ...
    <div class="row">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body text-center">
                    <?php if (!empty($committee['image_path'])): ?>
                        <img src="../../<?php echo htmlspecialchars($committee['image_path']); ?>" 
                    ...
                    <h4 class="mb-2">
                        <?php echo htmlspecialchars($committee['title'] . ' ' . $committee['first_name'] . ' ' . $committee['last_name']); ?>
                    </h4>
                    ...
                    <p class="text-info font-weight-bold">
                        <?php echo htmlspecialchars($committee['role']); ?>
                    </p>
                    
                    <?php if (!empty($committee['email'])): ?>
                    <p class="mb-2">
                        <i class="fas fa-envelope me-2 text-muted"></i>
                        <?php echo htmlspecialchars($committee['email']); ?>
                    </p>
                    <?php endif; ?>
                    
                    <?php if (!empty($committee['phone'])): ?>
                    <p class="mb-2">
                        <i class="fas fa-phone me-2 text-muted"></i>
                        <?php echo htmlspecialchars($committee['phone']); ?>
                    </p>
                    <?php endif; ?>
                    ...
                    <div class="row text-center">
                        <div class="col-4">
                            <p class="text-muted mb-1">หมวดหมู่</p>
                            <h6><?php echo $category_names[$committee['category']] ?? $committee['category']; ?></h6>
                        </div>
                        <div class="col-4">
                            <p class="text-muted mb-1">ลำดับ</p>
                            <h5><?php echo (int)$committee['order_number']; ?></h5>
                        </div>
                        <div class="col-4">
                            <p class="text-muted mb-1">สถานะ</p>
                            <?php if ($committee['status'] === 'active'): ?>
        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <?php if (!empty($committee['bio'])): ?>
                        <div class="bio-content">
                            <?php echo $committee['bio']; // HTML content from summernote ?>
                        </div>
                    <?php else: ?>
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($committee['title']); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-muted">ชื่อ:</td>
                                    <td><?php echo htmlspecialchars($committee['first_name']); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-muted">นามสกุล:</td>
                                    <td><?php echo htmlspecialchars($committee['last_name']); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-muted">หมวดหมู่:</td>
                                    <td><?php echo $category_names[$committee['category']] ?? $committee['category']; ?></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                <tr>
                                    <td class="text-muted">ตำแหน่งหลัก:</td>
                                    <td><?php echo htmlspecialchars($committee['position']); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-muted">บทบาท:</td>
                                    <td><?php echo htmlspecialchars($committee['role']); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-muted">เส้นทางรูปภาพ:</td>
                                    <td><?php echo !empty($committee['image_path']) ? htmlspecialchars($committee['image_path']) : '-'; ?></td>
                                </tr>
                                <tr>
                                    <td class="text-muted">ลำดับการแสดงผล:</td>
                                    <td><?php echo (int)$committee['order_number']; ?></td>
                                </tr>
                                <tr>
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td><?php echo date('d/m/Y H:i', strtotime($committee['created_at'])); ?></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td><?php echo date('d/m/Y H:i', strtotime($committee['updated_at'])); ?></td>
                                </tr>
                            </table>
                        </div>
                    </div>
