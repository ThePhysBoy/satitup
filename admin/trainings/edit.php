...
$id = (int)$_GET['id'];
$stmt = $conn->prepare("SELECT * FROM training_announcements WHERE id = ?");
...
$host_department = $training['host_department'];
...
$published_date = $training['published_date'];
$current_pdf = $training['document_pdf'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $conn->prepare("UPDATE training_announcements SET
            ...
            contact_person = ?, contact_phone = ?, contact_email = ?, status = ?, notes = ?, published_date = ?, updated_by = ?
            WHERE id = ?");
...
<head>
    ...
    <title>แก้ไขประกาศอบรม</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h3">แก้ไขประกาศอบรม</h1>
        ...
        <div class="card-body">
            ...
            <div class="row g-3 mt-3">
                <div class="col-md-4">
                    ...
                    <input type="date" name="registration_deadline" class="form-control" value="<?php echo htmlspecialchars($registration_deadline); ?>">
                </div>
                <div class="col-md-4">
