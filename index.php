...
<main class="main-content">
    ...
    <!-- ส่วนข่าวสารและกิจกรรมได้ถูกรวมไว้ใน news_announcements.php แล้ว -->
...
$(document).ready(function() {
    ...
    $('.partners-carousel').owlCarousel({
        ...
        margin: 25,              // ลดระยะห่างระหว่างรายการเพื่อรองรับขนาดที่ใหญ่ขึ้น
        nav: false,              // ไม่แสดงปุ่มนำทาง
        dots: true,              // แสดงจุดบ่งชี้ด้านล่าง
        autoplay: true,          // เล่นอัตโนมัติ
        autoplayTimeout: 3000,   // เปลี่ยนทุก 3 วินาที (ตามที่ต้องการ)
        autoplayHoverPause: true, // หยุดเมื่อเมาส์ชี้
        smartSpeed: 800,         // ความเร็วในการเปลี่ยนสไลด์ (มิลลิวินาที)
        slideTransition: 'linear', // การเคลื่อนไหวแบบเส้นตรง
        autoplaySpeed: 600,      // ความเร็วในการเล่นอัตโนมัติ
        dotsEach: 1,             // แสดงจุดทุกๆ 1 สไลด์
        // เอฟเฟกต์การเปลี่ยนสไลด์
        animateIn: 'fadeIn',     // เอฟเฟกต์เข้า
        animateOut: 'fadeOut',   // เอฟเฟกต์ออก
        // การปรับตัวตามขนาดหน้าจอ (Responsive)
        responsive: {
            0: {                 // หน้าจอขนาดเล็ก (น้อยกว่า 768px)
                items: 1,        // แสดง 1 รายการต่อแถว
                margin: 15,      // ระยะห่างน้อยลงสำหรับมือถือ
                dotsEach: 1      // จุดทุกๆ 1 สไลด์
            },
            768: {               // หน้าจอขนาดกลาง (768px ขึ้นไป)
                items: 2,        // แสดง 2 รายการต่อแถว
                margin: 20,      // ระยะห่างปานกลาง
                dotsEach: 1      // จุดทุกๆ 1 สไลด์
            },
            992: {               // หน้าจอขนาดใหญ่ (992px ขึ้นไป)
                items: 3,        // แสดง 3 รายการต่อแถว (ตามที่ต้องการ)
                margin: 25,      // ระยะห่างมาตรฐาน
                dotsEach: 1      // จุดทุกๆ 1 สไลด์
            }
        }
    });
...
<?php include_once 'university_departments.php'; ?>

<!-- นำเข้าส่วนลิงก์ภายนอก -->
<!-- แสดงลิงก์ไปยังเว็บไซต์ภายนอกที่เกี่ยวข้อง -->
<?php include_once 'external_links.php'; ?>
