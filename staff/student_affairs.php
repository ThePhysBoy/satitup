...
// Get staff by support type - student_affairs
$department_id = 10;
//$support_type = 'student_affairs';
//$staff_data = getStaffBySupportType($support_type, $conn);
$staff_data = getStaffByDepartment($department_id, $conn);
// Set page title
$page_title = "บุคลากรงานกิจการนักเรียน";
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">งานกิจการนักเรียน</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-12">
            <?php if (empty($staff_data)): ?>
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i> ไม่พบข้อมูลบุคลากรงานกิจการนักเรียน
                </div>
            <?php else: ?>
                <div class="row">
