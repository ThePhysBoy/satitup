...
// Get staff by support type - planning
$department_id = 11;
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">งานแผนงาน</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-12">
            <?php if (empty($staff_data)): ?>
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i> ไม่พบข้อมูลบุคลากรงานแผนงาน
                </div>
            <?php else: ?>
                <div class="row">
