...
if ($current_department_id > 0) {
    ...
    if ($department && $department['type'] === 'support') {
        ...
        // Redirect to service page if department is not service
        header("Location: service.php");
        exit;
    }
} else {
    // Get all support staff
    $staff_data = getStaffByType('support', $conn);
}

// Set page title based on current view
$page_title = "บุคลากรสายสนับสนุน";
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">สายสนับสนุน</li>
        ...
        <div class="col-md-3 mb-4">
            <div class="card shadow-sm">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="service.php" class="list-group-item list-group-item-action active">
                ...
                <div class="list-group list-group-flush">
                    <a href="service.php" class="list-group-item list-group-item-action <?php echo $current_department_id === 0 ? 'active' : ''; ?>">
                        <i class="fas fa-users me-2"></i> ทุกหน่วยงาน
                    </a>
                    <?php foreach ($support_departments as $dept): ?>
                        <a href="service.php?department=<?php echo $dept['id']; ?>" 
        ...
        <div class="col-md-9">
            <?php if (empty($staff_data)): ?>
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i> ไม่พบข้อมูลบุคลากรสายบริการ
                </div>
            <?php else: ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <h5 class="card-title">
                                                                ...
                                                                <span class="badge bg-primary ms-2">หัวหน้าหน่วยงาน</span>
                                                            </h5>
                                                            <?php
                                                            // Get positions
                                        ...
                                        <div class="col-md-6 col-lg-4 mb-4">
                                            <div class="card staff-card h-100">
                                                <div class="card-body text-center">
                                                    ...
                                                    <?php if (!empty($staff['phone'])): ?>
                                                        <p class="card-text"><small><i class="fas fa-phone me-1"></i> <?php echo htmlspecialchars($staff['phone']); ?></small></p>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
