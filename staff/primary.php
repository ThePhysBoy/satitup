...
// Get primary education departments
...
if ($current_department_id > 0) {
    ...
    if ($department && $department['type'] === 'primary') {
        ...
        // Redirect to primary page if department is not primary
        header("Location: primary.php");
        exit;
    }
} else {
    // Get all primary staff
    $staff_data = getStaffByType('primary', $conn);
}

// Set page title based on current view
$page_title = "บุคลากรประถมศึกษา";
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ประถมศึกษา</li>
    ...
    <div class="row">
        <div class="col-12">
            <h1 class="border-bottom pb-3 mb-4">
                <i class="fas fa-child me-2"></i><?php echo $page_title; ?>
            </h1>
        </div>
    </div>
        ...
        <div class="col-md-3 mb-4">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">ชั้นประถมศึกษา</h5>
                </div>
                <div class="list-group list-group-flush">
                    <a href="?department=0" class="list-group-item list-group-item-action <?php echo $current_department_id === 0 ? 'active' : ''; ?>">
                        <i class="fas fa-users me-2"></i> ทุกชั้นเรียน
                    </a>
                    <?php foreach ($primary_departments as $dept): ?>
                        <a href="?department=<?php echo $dept['id']; ?>" 
                ...
                <div class="card-header bg-light">
                    <h6 class="mb-0">ประเภทอื่นๆ</h6>
                </div>
                <div class="list-group list-group-flush">
                    <a href="academic.php" class="list-group-item list-group-item-action">
                        <i class="fas fa-chalkboard-teacher me-2"></i> สายวิชาการ
                    </a>
                    <a href="service.php" class="list-group-item list-group-item-action">
                        <i class="fas fa-user-cog me-2"></i> สายสนับสนุน
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <?php if (!empty($data['staff'])): ?>
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <?php 
                                    // First display department head/class teacher
                                    $has_head = false;
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <h5 class="card-title">
                                                                ...
                                                                <span class="badge bg-primary ms-2">ครูประจำชั้น</span>
                                                            </h5>
                                                            <?php
                                                            // Get positions
