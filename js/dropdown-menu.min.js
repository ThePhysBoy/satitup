  ...
  e.fn.extend({
    dropdown_menu: function (r) {
      ...
      return this.each(function () {
        ...
        e(">li", n).css({ "font-size": n.css("font-size") });
        n.css({ "font-size": "0" });
              ...
              e(this).data(
                ...
                setTimeout(
                  e.proxy(function () {
                    ...
                    if (u.vertical) {
                      n.css({ top: 0, left: e(this).outerWidth() });
                    } else {
                      n.css({ top: "", left: "" });
                    }
                    ...
                    if (overflow && u.viewport_overflow) {
                      var r = 10;
                      if (u.viewport_overflow === "auto")
                        u.viewport_overflow = s ? "scroll" : "move";
                      switch (u.viewport_overflow) {
                        case "move":
                          var i = overflow_x
                            ...
                            : n.offset().left;
                          var o = overflow_y
                            ? e(t).scrollTop() + e(t).height() - n.height() - r
                            : n.offset().top;
                          n.offset({ left: i, top: o });
                          break;
                        case "scroll":
                          if (overflow_x) {
                            var a =
                              ...
                              n.outerWidth() +
                              r;
                            e("html").animate({ scrollLeft: a }, "fast");
                          }
                          if (overflow_y) {
                            var f =
                              n.offset().top - e(t).height() + n.height() + r;
                            e("html").animate({ scrollTop: f }, "fast");
                          }
                          break;
                      }
                    }
                    n.hide().css({ visibility: "visible" });
                    if (u.animation_open) {
